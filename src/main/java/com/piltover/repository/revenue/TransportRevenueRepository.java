...
public interface TransportRevenueRepository extends JpaRepository<TransportRevenueRes, String>{
	...
	@Procedure("CallTransportRevenue")
	List<TransportRevenueRes> CallTransportRevenue(Date startDate, Date endDate);
}
